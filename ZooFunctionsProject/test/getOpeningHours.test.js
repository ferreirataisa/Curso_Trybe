...
describe('Testes da função getOpeningHours', () => {
  it('Se o argumento não for testado, retorna o horário de funcionamento da semana', () => {
  ...
  it('Para os argumentos Thursday e 09:00-PM deve lançar uma exceção com a mensagem: "The day must be valid. Example: Monday"', () => {
  ...
  it('Para os argumentos Friday e 09:00-PM deve lançar uma exceção com a mensagem: "The abbreviation must be \'AM\' or \'PM\'"', () => {
